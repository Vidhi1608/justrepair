...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index3.html" class="brand-link text-center">
      <img src="{{url('images')}}/justrepairit-white-logo.png" alt="AdminLTE Logo" class="brand-image float-none">
    </a>
  ...
  <div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark">Users Role</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 {{-- <h1>Hello! this is {{$users->role_id}}and </h1> --}} 
...
@else 
 <div class="text-center">
     <hr>
     <h1>Hello this is Technician!</h1>
 </div>
