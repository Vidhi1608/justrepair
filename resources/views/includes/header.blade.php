...
<script>
  ...
  gtag('config', 'UA-157026226-1');
  gtag('config', 'AW-763069487');
</script>
...
function gtag_report_conversion(url) {
  ...
  gtag('event', 'conversion', {
      'send_to': 'AW-763069487/YlGWCMiGuJ8BEK-I7usC',
...
<link rel="stylesheet" type="text/css" href="{{url('css/justrepair.css')}}">
<link rel="shortcut icon" type="image/png" href="{{url('images/fevicon.png')}}" />
<link rel="apple-touch-icon" href="{{url('images/fevicon.png')}}" />
