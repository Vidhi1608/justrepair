        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-md-10">
              ...
              <form class="form-group p-3" action="/invoice" method="POST">
                        @csrf
                                ...
                                <table class="table table-hover" id="tab_logic" cellpadding="1">
                                    ...
                                    <tbody>
                                        <tr id='addr0'>
                                            ...
                                            <td><input type="text" name='product[]' placeholder='Enter Item' class="form-control" required></td>
                                            <td class="d-none"><input type="number" name='qty[]' placeholder='Enter Qty' class="form-control qty" step="0" min="0" value="1" /></td>
                                            <td><input type="number" name='price[]' placeholder='Enter Price' class="form-control price" step="0.00" min="0" required></td>
