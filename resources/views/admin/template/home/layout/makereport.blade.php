        ...
        <div class="container-fluid">
          <div class="row justify-content-center">
            <div class="col-md-10">
              ...
              <form class="form-group p-3" action="/invoice_update" method="POST">
                        @csrf
                        <input type="hidden" name="bill_id" value= "{{$complaint->bill->id}}">
                                ...
                                <table class="table table-hover" id="tab_logic" cellpadding="1">
                                    ...
                                    <tbody>
                                        ...
                                        <tr id='addr0'>
                                            ...
                                            <td class="d-none"><input type="number" name='qty[]' placeholder='{{$key}}' class="form-control qty" step="0" min="0" value="1" disabled></td>
                                            <td><input type="number" name='price[]' placeholder="" class="form-control price" step="0.00" min="0" required></td>
                            ...
                            <div class=" mt-3 text-center">
                                <button type="submit" class="btn btn-success px-3 shadow" style="font-size: 15px !important;">SUBMIT</button>
                            </div>
                    </form>
                </div>
            </div>
